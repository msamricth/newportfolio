...
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, hasProtocol, withHttps, withoutProtocol, withLeadingSlash, withoutTrailingSlash, withBase, parsePath, parseQuery, stringifyQuery, encodePath, stringifyParsedURL, joinRelativeURL } from 'file:///Users/emmatalarico/www/newportfolio/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file:///Users/emmatalarico/www/newportfolio/node_modules/vue/server-renderer/index.mjs';
import destr, { destr as destr$1 } from 'file:///Users/emmatalarico/www/newportfolio/node_modules/destr/dist/index.mjs';
...
import { createStorage, prefixStorage } from 'file:///Users/emmatalarico/www/newportfolio/node_modules/unstorage/dist/index.mjs';
...
import consola, { consola as consola$1, createConsola } from 'file:///Users/emmatalarico/www/newportfolio/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file:///Users/emmatalarico/www/newportfolio/node_modules/youch-core/build/index.js';
import { Youch } from 'file:///Users/emmatalarico/www/newportfolio/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file:///Users/emmatalarico/www/newportfolio/node_modules/source-map/source-map.js';
import { AsyncLocalStorage } from 'node:async_hooks';
import { stringify, uneval } from 'file:///Users/emmatalarico/www/newportfolio/node_modules/devalue/index.js';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///Users/emmatalarico/www/newportfolio/node_modules/errx/dist/index.js';
import { isVNode, toValue, isRef } from 'file:///Users/emmatalarico/www/newportfolio/node_modules/vue/index.mjs';
import devalue from 'file:///Users/emmatalarico/www/newportfolio/node_modules/@nuxt/devalue/dist/devalue.mjs';
...
import { DeprecationsPlugin, PromisesPlugin, TemplateParamsPlugin, AliasSortingPlugin } from 'file:///Users/emmatalarico/www/newportfolio/node_modules/nuxt/node_modules/unhead/dist/plugins.mjs';
...
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/emmatalarico/www/newportfolio/.data/kv"}));
...
const _5gFiug1yC5hILPgFIWWjZnzCZtlEr63Xs4YMtqDRqWU = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "/Users/emmatalarico/www/newportfolio";
...
const _kPf3IhDGDI61L_FPOapqSjgyYlW4w2el7lQX97KvM = (nitroApp) => {
...
const plugins = [
  _5gFiug1yC5hILPgFIWWjZnzCZtlEr63Xs4YMtqDRqWU,
_kPf3IhDGDI61L_FPOapqSjgyYlW4w2el7lQX97KvM,
...
const _Zl02lp = defineEventHandler(async (e) => {
...
const _VC3Kcx = defineEventHandler(async (e) => {
...
const getServerEntry = () => import('file:///Users/emmatalarico/www/newportfolio/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
const getClientManifest = () => import('file:///Users/emmatalarico/www/newportfolio/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
...
const _lazy_KgM37O = () => Promise.resolve().then(function () { return gitAuth$1; });
const _lazy_c2bE1x = () => Promise.resolve().then(function () { return renderer$1; });
...
const handlers = [
  ...
  { route: '/__site-config__/debug.json', handler: _Zl02lp, lazy: false, middleware: false, method: undefined },
  { route: '/__sitemap__/debug.json', handler: _VC3Kcx, lazy: false, middleware: false, method: undefined },
