...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, getRequestURL, getResponseHeader, getRequestHost, getRequestProtocol, setHeader, getHeader, getResponseStatus, createError, getQuery as getQuery$1, readBody, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getRouterParam, getResponseStatusText } from 'file://C:/Users/emmta/Local%20Sites/newportfolio/node_modules/h3/dist/index.mjs';
import { escapeHtml } from 'file://C:/Users/emmta/Local%20Sites/newportfolio/node_modules/@vue/shared/dist/shared.cjs.js';
...
import destr, { destr as destr$1 } from 'file://C:/Users/emmta/Local%20Sites/newportfolio/node_modules/destr/dist/index.mjs';
...
import { isVNode, toValue, isRef } from 'file://C:/Users/emmta/Local%20Sites/newportfolio/node_modules/vue/index.mjs';
import { DeprecationsPlugin, PromisesPlugin, TemplateParamsPlugin, AliasSortingPlugin } from 'file://C:/Users/emmta/Local%20Sites/newportfolio/node_modules/nuxt/node_modules/unhead/dist/plugins.mjs';
...
import consola, { consola as consola$1, createConsola } from 'file://C:/Users/emmta/Local%20Sites/newportfolio/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file://C:/Users/emmta/Local%20Sites/newportfolio/node_modules/youch-core/build/index.js';
import { Youch } from 'file://C:/Users/emmta/Local%20Sites/newportfolio/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file://C:/Users/emmta/Local%20Sites/newportfolio/node_modules/source-map/source-map.js';
import { AsyncLocalStorage } from 'node:async_hooks';
import { getContext } from 'file://C:/Users/emmta/Local%20Sites/newportfolio/node_modules/unctx/dist/index.mjs';
import { captureRawStackTrace, parseRawStackTrace } from 'file://C:/Users/emmta/Local%20Sites/newportfolio/node_modules/errx/dist/index.js';
import devalue from 'file://C:/Users/emmta/Local%20Sites/newportfolio/node_modules/@nuxt/devalue/dist/devalue.mjs';
...
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"C:/Users/emmta/Local Sites/newportfolio/.data/kv"}));
...
const _qkMBUyAO4a60Ha7NuRHCgi9I6ybu55ApK6_ufUHBIQ = (nitroApp) => {
...
const plugins = [
  _MQ_HemxxYw5eovHQ1ID_ziZe1Ua5Fl_ZJxkmAl3HKaQ,
_qkMBUyAO4a60Ha7NuRHCgi9I6ybu55ApK6_ufUHBIQ,
...
const _18Mt0a = defineEventHandler(async (e) => {
...
const _26CK6D = defineEventHandler(async (e) => {
...
const getServerEntry = () => import('file://C:/Users/emmta/Local%20Sites/newportfolio/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
const getClientManifest = () => import('file://C:/Users/emmta/Local%20Sites/newportfolio/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
...
const _lazy_dqKRfw = () => Promise.resolve().then(function () { return gitAuth$1; });
const _lazy_1l9Stg = () => Promise.resolve().then(function () { return renderer$1; });
...
const handlers = [
  ...
  { route: '/__site-config__/debug.json', handler: _18Mt0a, lazy: false, middleware: false, method: undefined },
  { route: '/__sitemap__/debug.json', handler: _26CK6D, lazy: false, middleware: false, method: undefined },
...
const gitAuth = defineEventHandler(async (event) => {
  const config = useRuntimeConfig();
  const gistId = getQuery$1(event).id;
  if (!gistId) {
...
const gitAuth$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: gitAuth
});
