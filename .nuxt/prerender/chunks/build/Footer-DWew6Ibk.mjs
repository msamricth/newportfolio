...
const _sfc_main$2 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-c8f8b700><div class="h-full flex items-center sticky top-45 justify-center mx-auto pb-12 mb-4 lg:mb-8 px-6 flex-col max-w-[778px] relative xl:pb-24 xl:pb-16" data-v-c8f8b700><h3 data-splitting="words" id="formHeader" class="${ssrRenderClass([submitted.value ? "blur-sm" : "", "text-4xl font-black transition-all text-center mb-6 lg:mb-12 form-header uppercase placeholder-line"])}" data-v-c8f8b700>Lets get in touch!</h3>`);
      if (submitted.value) {
        _push(`<div class="text-center pt-16 fade-up absolute z-30" id="thanks" data-v-c8f8b700><h4 class="text-3xl mb-2 font-bold text-yellow" data-v-c8f8b700>Message sent!</h4><p class="text-white" data-v-c8f8b700>We&#39;ll be in touch, thanks! </p></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<form novalidate class="${ssrRenderClass([submitted.value ? "blur-md opacity-25" : "", "transition-all w-full px-2 block flex flex-col gap-6 text-primary dark:text-accent inverted:text-electric-purple"])}" data-v-c8f8b700>`);
      if (error.value) {
        _push(`<div class="text-electric-purple text-sm mb-2" data-v-c8f8b700>${ssrInterpolate(error.value)}</div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<div class="flex flex-wrap w-full" data-v-c8f8b700><div class="relative w-1/2 pr-4" data-v-c8f8b700><label class="sr-only focus:not-sr-only" tabindex="0" for="name" data-v-c8f8b700> Name </label><input type="text" placeholder="Name" id="name" name="name"${ssrRenderAttr("value", formDataValues.name)} class="${ssrRenderClass([{ "border-b border-yellow": nameError.value }, "w-full outline-0 h-12 pb-2 p bg-transparent border-current border rounded-[6rem] pl-6 py-[10px] pr-3 outline-none transition-all active:border-green disabled:cursor-default disabled:bg-gray-2 text-xl focus:border-green bg-transparent text-primary dark:text-accent inverted:text-electric-purple placeholder:text-primary/60 focus:placeholder:text-primary dark:placeholder:text-accent/60 dark:focus:placeholder:text-accent inverted:placeholder:text-electric-purple/60 inverted:focus:placeholder:text-electric-purple"])}" data-v-c8f8b700></div><div class="w-1/2" data-v-c8f8b700><label for="email" class="sr-only focus:not-sr-only" tabindex="0" data-v-c8f8b700> Email </label><input type="email" id="email" placeholder="Email" name="email"${ssrRenderAttr("value", formDataValues.email)} required class="${ssrRenderClass([{ "border-b border-yellow": emailError.value }, "w-full outline-0 h-12 pb-2 p bg-transparent border-current border rounded-[6rem] pl-6 py-[10px] pr-3 outline-none transition-all active:border-green disabled:cursor-default disabled:bg-gray-2 text-xl focus:border-green text-primary dark:text-accent inverted:text-electric-purple placeholder:text-primary/60 focus:placeholder:text-primary dark:placeholder:text-accent/60 dark:focus:placeholder:text-accent inverted:placeholder:text-electric-purple/60 inverted:focus:placeholder:text-electric-purple"])}" data-v-c8f8b700></div></div><label for="message" class="sr-only focus:not-sr-only" tabindex="0" data-v-c8f8b700> Type your message </label><textarea class="${ssrRenderClass([{ "border-b border-yellow": messageError.value }, "placeholder:text-current/60 focus:placeholder:text-current outline-0 h-22 pb-2 p bg-transparent border-current border rounded-[1rem] pl-6 py-6 text-primary dark:text-accent inverted:text-electric-purple"])}" id="message" name="message" placeholder="Your message" required data-v-c8f8b700>${ssrInterpolate(formDataValues.message)}</textarea><div class="hidden" data-v-c8f8b700><input type="text" id="hpField" name="hpField"${ssrRenderAttr("value", formDataValues.hpField)} tabindex="-1" autocomplete="off" data-v-c8f8b700></div><div data-v-c8f8b700><button type="submit" class="relative submit flex items-center transition-all overflow-hidden w-60 ml-auto text-center group/cta" data-v-c8f8b700><span class="inline-block font-semibold px-4 py-2 border-current border-2 rounded-full transition-all-all relative z-10 bg-inherit w-full whitespace-nowrap" data-v-c8f8b700> Submit </span><span class="absolute right-0 top-0 w-0 h-full opacity-0 transition-all-all z-0 origin-left block overflow-clip" data-v-c8f8b700><span class="flex items-center justify-center rounded-r-full bg-current h-full transition-all-all z-0 origin-left block w-10" data-v-c8f8b700><svg class="arrow w-24 h-24 fill-current" viewBox="0 0 24 24" data-v-c8f8b700><path d="M8 5l8 7-8 7z" data-v-c8f8b700></path></svg></span></span></button></div></form></div></section>`);
    };
  }
};
...
const Contact = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-c8f8b700"]]);
const _sfc_main$1 = {
  __name: "SecondaryNav",
  __ssrInlineRender: true,
  props: {
...
const SecondaryNav = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-b86ce407"]]);
const _sfc_main = {
  __name: "Footer",
  __ssrInlineRender: true,
  setup(__props) {
...
//# sourceMappingURL=Footer-DWew6Ibk.mjs.map
