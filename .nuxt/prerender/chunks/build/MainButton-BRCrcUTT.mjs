  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<a${ssrRenderAttrs(mergeProps({
        ...
        ref_key: "buttonEl",
        ref: buttonEl
      }, _attrs))} data-v-2d997889><span class="inline-block font-semibold px-4 py-2 border-current border-2 rounded-full transition-all relative z-10 bg-inherit w-full text-nowrap" data-v-2d997889>${ssrInterpolate(__props.label)}</span><span class="absolute right-0 w-10 top-0 h-full opacity-0 transition-all z-0 origin-right block" data-v-2d997889><span class="flex items-center justify-center rounded-r-full h-full z-0 origin-right w-10 transition-colors bg-current" data-v-2d997889><svg class="arrow w-14 h-14 absolute fill-current transition-all text-current" viewBox="0 0 24 24" data-v-2d997889><path d="M8 5l8 7-8 7z" data-v-2d997889></path></svg></span></span></a>`);
    };
  }
};
...
const MainButton = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-2d997889"]]);

export { MainButton as M };
//# sourceMappingURL=MainButton-BRCrcUTT.mjs.map
