...
const styles = {
  ...
  "components/contexts/WorkItem.vue": () => import('./WorkItem-styles.B6Svk2rN.mjs').then(interopDefault),
  "components/navigation/Hamburger.vue": () => import('./Hamburger-styles.kdiGOZTu.mjs').then(interopDefault),
  "components/contexts/WorkItem.vue?vue&type=style&index=0&scoped=a74602c9&lang.css": () => import('./WorkItem-styles.Cu6kZ8ZU.mjs').then(interopDefault),
