...
import { ssrRenderSuspense, ssrRenderComponent, ssrRenderVNode } from 'file://C:/Users/emmta/Local%20Sites/newportfolio/node_modules/vue/server-renderer/index.mjs';
...
const _routes = [
  {
    name: "About",
    path: "/About",
    component: () => import('./About-BIubX-gf.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-CJARVrNC.mjs')
  },
  {
    name: "work-glt",
    path: "/work/glt",
    meta: __nuxt_page_meta || {},
    component: () => import('./glt-bGtIF-su.mjs')
  },
  {
    name: "work",
    path: "/work",
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-DmEBUU-x.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-BrpuxlwB.mjs'));
...
export { useMainStore as a, useRouter as b, useRuntimeConfig as c, nuxtLinkDefaults as d, entry$1 as default, navigateTo as n, resolveRouteObject as r, tryUseNuxtApp as t, useNuxtApp as u };
