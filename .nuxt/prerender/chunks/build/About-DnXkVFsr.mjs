...
const _sfc_main$8 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "overflow-x-clip motion-reduce:hidden w-full header-scenes" }, _attrs))} data-v-d2e75f62><div class="flex flex-col md:flex-row justify-center lg:justify-between items-start md:gap-6 max-w-full lg:max-w-[1024px] xl:max-w-[1440px] mx-auto lg:px-12 relative pt-22 md:py-0 lg:py-8 overflow-visible h-[85dvh] px-8 xl:items-center" data-v-d2e75f62><div class="flex flex-col justify-center gap-6 md:gap-0 lg:px-4 w-full md:max-w-3/5 lg:max-w-3xl relative z-20 font-heading animating h-dvh md:min-h-[70vh] xl:h-full lg:gap-8 2xl:gap-10 max-h-190" data-v-d2e75f62><div class="flex max-md:flex-wrap md:flex-nowrap justify-between md:justify-center gap-6 items-center w-full row-1 row leading-1" data-v-d2e75f62><span id="charA" class="h1 text-6xl lg:text-7xl font-extrabold bounce-in fold" data-v-d2e75f62>A</span><span id="charHeart" class="h1 text-6xl lg:text-7xl font-extrabold text-center" data-v-d2e75f62> HEART </span><img crossorigin="anonymous" src="https://res.cloudinary.com/dp1qyhhlo/image/upload/v1745346872/heart_dfz3gf.svg" alt="Illustration of a heart" id="icon" class="w-24 self-start max-w-60 jello-horizontal h-full object-contain object-center" data-v-d2e75f62></div><div class="flex max-lg:flex-wrap lg:flex-nowrap justify-center gap-6 lg:gap-24 w-full row-2 row lg:-mt-10" data-v-d2e75f62><span id="charOf" class="text-8xl font-extrabold h1 fold" data-v-d2e75f62> OF </span><span id="charFire" class="text-8xl font-extrabold h1 fold" data-v-d2e75f62> FIRE </span></div><div class="flex max-md:flex-col md:flex-nowrap justify-center max-md:items-center md:justify-between gap-6 w-full md:w-fit max-w-4xl lg:max-w-2xl mx-auto row-3 row -rotate-5 leading-1.8 md:-mb-2 lg:-mt-4" style="${ssrRenderStyle({ "opacity": "0" })}" data-v-d2e75f62><span class="text-7xl md:text-4xl lg:text-8mxl font-extrabold the h1 row md:text-left" data-v-d2e75f62>THE</span><span class="text-6xl md:text-4xl lg:text-8mxl font-extrabold explosions h1 row max-w-full max-md:break-all pb-6 lg:pb-0" id="exp" data-v-d2e75f62>EXPLOSIONS</span></div><div class="flex flex-nowrap justify-center gap-6 w-full row-4 row md:leading-1" data-v-d2e75f62><span class="text-7xl font-extrabold h1" style="${ssrRenderStyle({ "opacity": "0" })}" data-v-d2e75f62> DONT </span><span class="text-7xl font-extrabold h1" style="${ssrRenderStyle({ "opacity": "0" })}" data-v-d2e75f62> EVEN </span></div><div class="flex flex-nowrap justify-center gap-6 w-full row-5 row leading-1 lg:-mt-10" data-v-d2e75f62><span class="text-8xl md:text-7xl lg:text-8xl font-extrabold h1" style="${ssrRenderStyle({ "opacity": "0" })}" data-v-d2e75f62> SCARE </span><span class="text-8xl md:text-7xl lg:text-8xl font-extrabold h1" style="${ssrRenderStyle({ "opacity": "0" })}" data-v-d2e75f62> ME </span></div><div class="absolute bottom-0 opacity-0 -bottom-30 z-0 w-full lg:-bottom-10 xl:bottom-10" id="fire" data-v-d2e75f62>`);
      _push(ssrRenderComponent(Fire, null, null, _parent));
      _push(`</div></div><div class="max-w-lg hidden md:flex ml-auto flex-col relative md:w-1/2 z-10 md:max-w-50 lg:max-w-60 xl:max-w-70 justify-center 2xl:max-w-100 h-full" data-v-d2e75f62><img src="https://res.cloudinary.com/dp1qyhhlo/image/upload/v1748635877/1744399801866_qxlwrk.webp" alt="Emm as an action figure" class="w-auto object-contain" id="introImage" data-v-d2e75f62></div>`);
      if (loaded.value) {
        ...
        ])}" data-v-d2e75f62><button class="absolute top-2.5 right-4 hover:scale-[1.08] transition-all bg-[#1f1f1f] rounded-[3rem] cursor-pointer" data-v-d2e75f62><svg height="24px" class="text-current fill-current" id="Layer_1" style="${ssrRenderStyle({ "enable-background": "new 0 0 512 512" })}" version="1.1" viewBox="0 0 512 512" width="24px" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" data-v-d2e75f62><g data-v-d2e75f62><path d="M256,33C132.3,33,32,133.3,32,257c0,123.7,100.3,224,224,224c123.7,0,224-100.3,224-224C480,133.3,379.7,33,256,33z    M364.3,332.5c1.5,1.5,2.3,3.5,2.3,5.6c0,2.1-0.8,4.2-2.3,5.6l-21.6,21.7c-1.6,1.6-3.6,2.3-5.6,2.3c-2,0-4.1-0.8-5.6-2.3L256,289.8   l-75.4,75.7c-1.5,1.6-3.6,2.3-5.6,2.3c-2,0-4.1-0.8-5.6-2.3l-21.6-21.7c-1.5-1.5-2.3-3.5-2.3-5.6c0-2.1,0.8-4.2,2.3-5.6l75.7-76   l-75.9-75c-3.1-3.1-3.1-8.2,0-11.3l21.6-21.7c1.5-1.5,3.5-2.3,5.6-2.3c2.1,0,4.1,0.8,5.6,2.3l75.7,74.7l75.7-74.7   c1.5-1.5,3.5-2.3,5.6-2.3c2.1,0,4.1,0.8,5.6,2.3l21.6,21.7c3.1,3.1,3.1,8.2,0,11.3l-75.9,75L364.3,332.5z" data-v-d2e75f62></path></g></svg></button><iframe class="w-full max-w-md h-20 rounded-lg" src="https://open.spotify.com/embed/track/3Bp3aq6ftmUhxajD9T9kik?utm_source=generator&amp;theme=0" frameborder="0" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" data-v-d2e75f62></iframe></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<div class="w-full order-3 md:absolute md:bottom-6 lg:bottom-0 md:px-8 lg:px-12 z-40 max-w-full lg:max-w-[1024px] xl:max-w-[1440px] left-0" data-v-d2e75f62><div class="flex flex-nowrap justify-between items-end w-full" data-v-d2e75f62><span class="text-sm text-gray-500 animate subtle-slide-in flex gap-1" data-v-d2e75f62><svg enable-background="new 0 0 64 64" class="text-current fill-current" height="18px" id="Layer_1" version="1.1" viewBox="0 0 64 64" width="18px" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" data-v-d2e75f62><path d="M23.727,16.403v4.84v5.058v14.236c-1.268-0.777-2.754-1.233-4.35-1.233c-4.612,0-8.353,3.74-8.353,8.349  c0,4.614,3.74,8.354,8.353,8.354c4.61,0,8.349-3.739,8.35-8.352h0V25.151l21.25-6.109V33.33c-1.268-0.777-2.754-1.233-4.35-1.233  c-4.614,0-8.353,3.739-8.353,8.348c0,4.613,3.739,8.354,8.353,8.354c4.344,0,7.914-3.325,8.31-7.57h0.04V17.892v-3.586V7.993  L23.727,16.403z" data-v-d2e75f62></path></svg><em data-v-d2e75f62><strong data-v-d2e75f62>Random Lyric</strong></em></span><button class="btn-secondary bg-gray-800 text-white p-2 rounded-[3rem] cursor-pointer transition-all hover:scale-[1.08] hover:text-accent duration-700" aria-label="Toggle lyric" data-v-d2e75f62><svg class="bi bi-question-circle-fill" fill="currentColor" height="16" viewBox="0 0 16 16" width="16" xmlns="http://www.w3.org/2000/svg" data-v-d2e75f62><path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zM5.496 6.033h.825c.138 0 .248-.113.266-.25.09-.656.54-1.134 1.342-1.134.686 0 1.314.343 1.314 1.168 0 .635-.374.927-.965 1.371-.673.489-1.206 1.06-1.168 1.987l.003.217a.25.25 0 0 0 .25.246h.811a.25.25 0 0 0 .25-.25v-.105c0-.718.273-.927 1.01-1.486.609-.463 1.244-.977 1.244-2.056 0-1.511-1.276-2.241-2.673-2.241-1.267 0-2.655.59-2.75 2.286a.237.237 0 0 0 .241.247zm2.325 6.443c.61 0 1.029-.394 1.029-.927 0-.552-.42-.94-1.029-.94-.584 0-1.009.388-1.009.94 0 .533.425.927 1.01.927z" data-v-d2e75f62></path></svg></button></div></div><div class="absolute top-0 w-full bottom-0 left-0 h-full z-0 lg:top-18 lg:h-[80vh] lg:w-3/4 overflow-visible" data-v-d2e75f62><canvas id="myCanvas" class="overflow-visible" data-v-d2e75f62></canvas></div></div></div>`);
    };
  }
};
...
const Lyric = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["__scopeId", "data-v-d2e75f62"]]);
const _sfc_main$7 = {
  __name: "About",
  __ssrInlineRender: true,
  setup(__props) {
...
//# sourceMappingURL=About-DnXkVFsr.mjs.map
