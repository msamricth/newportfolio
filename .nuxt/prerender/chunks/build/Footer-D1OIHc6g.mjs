...
const _sfc_main$2 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-839e8a1f><div class="h-full flex items-center sticky top-45 justify-center mx-auto pb-12 mb-4 lg:mb-8 px-6 flex-col max-w-[778px] relative xl:pb-24 xl:pb-16" data-v-839e8a1f><h3 data-splitting="words" id="formHeader" class="${ssrRenderClass([submitted.value ? "blur-sm" : "", "text-4xl font-black transition-all text-center mb-6 lg:mb-12 form-header uppercase placeholder-line"])}" data-v-839e8a1f>Lets get in touch!</h3>`);
      if (submitted.value) {
        _push(`<div class="text-center pt-16 fade-up absolute z-30" id="thanks" data-v-839e8a1f><h4 class="text-3xl mb-2 font-bold mb-2 text-yellow" data-v-839e8a1f>Success</h4><p class="text-white" data-v-839e8a1f>ss </p></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<form novalidate class="${ssrRenderClass([submitted.value ? "blur-md opacity-25" : "", "transition-all w-full px-2 block flex flex-col gap-6 text-primary dark:text-accent inverted:text-electric-purple"])}" data-v-839e8a1f>`);
      if (error.value) {
        _push(`<div class="text-electric-purple text-sm mb-2" data-v-839e8a1f>${ssrInterpolate(error.value)}</div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<div class="flex flex-wrap w-full" data-v-839e8a1f><div class="relative w-1/2 pr-4" data-v-839e8a1f><label class="sr-only focus:not-sr-only" tabindex="0" for="name" data-v-839e8a1f> Name </label><input type="text" placeholder="Name" id="name" name="name"${ssrRenderAttr("value", formDataValues.name)} class="${ssrRenderClass([{ "border-b border-yellow": nameError.value }, "w-full outline-0 h-12 pb-2 p bg-transparent border-current border rounded-[6rem] pl-6 py-[10px] pr-3 outline-none transition-all active:border-green disabled:cursor-default disabled:bg-gray-2 text-xl focus:border-green bg-transparent text-primary dark:text-accent inverted:text-electric-purple placeholder:text-primary/60 focus:placeholder:text-primary dark:placeholder:text-accent/60 dark:focus:placeholder:text-accent inverted:placeholder:text-electric-purple/60 inverted:focus:placeholder:text-electric-purple"])}" data-v-839e8a1f></div><div class="w-1/2" data-v-839e8a1f><label for="email" class="sr-only focus:not-sr-only" tabindex="0" data-v-839e8a1f> Email </label><input type="email" id="email" placeholder="Email" name="email"${ssrRenderAttr("value", formDataValues.email)} required class="${ssrRenderClass([{ "border-b border-yellow": emailError.value }, "w-full outline-0 h-12 pb-2 p bg-transparent border-current border rounded-[6rem] pl-6 py-[10px] pr-3 outline-none transition-all active:border-green disabled:cursor-default disabled:bg-gray-2 text-xl focus:border-green text-primary dark:text-accent inverted:text-electric-purple placeholder:text-primary/60 focus:placeholder:text-primary dark:placeholder:text-accent/60 dark:focus:placeholder:text-accent inverted:placeholder:text-electric-purple/60 inverted:focus:placeholder:text-electric-purple"])}" data-v-839e8a1f></div></div><label for="message" class="sr-only focus:not-sr-only" tabindex="0" data-v-839e8a1f> Type your message </label><textarea class="${ssrRenderClass([{ "border-b border-yellow": messageError.value }, "placeholder:text-current/60 focus:placeholder:text-current outline-0 h-22 pb-2 p bg-transparent border-current border rounded-[1rem] pl-6 py-6 text-primary dark:text-accent inverted:text-electric-purple"])}" id="message" name="message" placeholder="Your message" required data-v-839e8a1f>${ssrInterpolate(formDataValues.message)}</textarea><div class="hidden" data-v-839e8a1f><input type="text" id="hpField" name="hpField"${ssrRenderAttr("value", formDataValues.hpField)} tabindex="-1" autocomplete="off" data-v-839e8a1f></div><div data-v-839e8a1f><button type="submit" class="relative submit flex items-center transition-all overflow-hidden w-60 ml-auto text-center group/cta" data-v-839e8a1f><span class="inline-block font-semibold px-4 py-2 border-current border-2 rounded-full transition-all-all relative z-10 bg-inherit w-full whitespace-nowrap" data-v-839e8a1f> Submit </span><span class="absolute right-0 top-0 w-0 h-full opacity-0 transition-all-all z-0 origin-left block overflow-clip" data-v-839e8a1f><span class="flex items-center justify-center rounded-r-full bg-current h-full transition-all-all z-0 origin-left block w-10" data-v-839e8a1f><svg class="arrow w-24 h-24 fill-current" viewBox="0 0 24 24" data-v-839e8a1f><path d="M8 5l8 7-8 7z" data-v-839e8a1f></path></svg></span></span></button></div></form></div></section>`);
    };
  }
};
...
const Contact = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-839e8a1f"]]);
const _sfc_main$1 = {
  __name: "SecondaryNav",
  __ssrInlineRender: true,
  props: {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "secondary-nav group/secondaryNav max-w-1440 px-0 md:px-12 flex justify-end items-center relative gap-8 md:gap-6" }, _attrs))} data-v-fe9db33a>`);
...
const SecondaryNav = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-fe9db33a"]]);
const _sfc_main = {
  __name: "Footer",
  __ssrInlineRender: true,
  setup(__props) {
...
export { Contact as C, Hamburger as H, Splitting as S, _sfc_main as _, SecondaryNav as a, _sfc_main$7 as b, _sfc_main$4 as c, _sfc_main$5 as d };
//# sourceMappingURL=Footer-D1OIHc6g.mjs.map
