...
import { C as Contact, _ as _sfc_main$c, S as Splitting } from './Footer-D1OIHc6g.mjs';
...
class PlaceholderJS {
  ...
  _injectPlaceholders() {
    ...
    if (this.el.classList.contains("placeholder-added")) {
      const words = (_a = this.words) != null ? _a : Array.from(this.el.querySelectorAll(".word"));
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "font-main bg-background text-primary dark:text-background dark:bg-deep-purple inverted:text-background inverted:bg-deep-purple inverted:dark:bg-background inverted:dark:text-primary transition duration-700 relative" }, _attrs))} data-v-df7c74d8><div class="utilities max-w-full px-8 lg:px-12 lg:max-w-[1024px] xl:max-w-[1440px] mx-auto pt-9 lg:pt-12 pb-18 lg:pb-20" data-v-df7c74d8>`);
      ...
      _push(`<div class="flex flex-col gap-6 max-w-full mt-6 lg:max-w-[1024px] xl:max-w-[1440px] mx-auto items-start" data-v-df7c74d8>`);
...
const About = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-df7c74d8"]]);

export { About as default };
//# sourceMappingURL=About-CMDaWOko.mjs.map
