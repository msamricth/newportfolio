...
import { b as _sfc_main$4, c as _sfc_main$5, H as Hamburger } from './Footer-Bsaj43Au.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_NuxtLink = __nuxt_component_0;
      _push(`<!--[--><div data-v-08f73454></div><header id="nav" class="${ssrRenderClass([isSticky.value ? "fixed left-0 w-full bg-background/70 dark:bg-primary/70 inverted:bg-primary/70 inverted:dark:bg-background/70 backdrop-blur transition duration-700" : " absolute ", "py-4 mx-auto z-20 w-full will-change-transform transform-gpu"])}" data-v-08f73454><div class="nav-wrapper max-w-full px-8 lg:px-12 lg:max-w-[1024px] xl:max-w-[1440px] mx-auto flex items-center relative" data-v-08f73454><div class="${ssrRenderClass([isSticky.value ? "opacity-75 duration-700 hover:opacity-100" : "opacity-0 duration-0", "text-primary dark:text-background inverted:text-background inverted:dark:text-primary nav-brand transition-all relative max-sm:z-10"])}" data-v-08f73454>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
      ...
      _push(`</div><h1 class="placeholder-line absolute left-8 lg:left-12 transition-all headingClass top-0 text-3xl md:text-5xl text-nowrap" data-splitting="words" data-v-08f73454><span class="transition-all duration-700 placeholder-line text-primary dark:text-background inverted:text-background" data-splitting="words" data-v-08f73454>${ssrInterpolate(__props.title)}</span></h1><nav class="${ssrRenderClass([isSticky.value ? [""] : ["opacity-0"], "flex space-x-8 text-sm font-heading font-semibold group/nav ml-auto text-primary dark:text-background inverted:text-background inverted:dark:text-primary"])}" data-v-08f73454>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span class="nav-item" data-v-08f73454${_scopeId}>about</span>`);
          } else {
            return [
              createVNode("span", {
                class: "nav-item",
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span class="nav-item" data-v-08f73454${_scopeId}>work</span>`);
          } else {
            return [
              createVNode("span", {
                class: "nav-item",
      ...
      _push(`<a href="#sayHello" class="group-hover/nav:opacity-70 group-hover/nav:hover:opacity-100 transition relative overflow-clip duration-700" data-v-08f73454><span class="nav-item" data-v-08f73454>say hello</span></a></nav></div></header><!--]-->`);
    };
  }
};
...
const InnerNav = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-08f73454"]]);

export { InnerSecondaryNav as I, InnerNav as a };
//# sourceMappingURL=InnerNav-j460hikE.mjs.map
