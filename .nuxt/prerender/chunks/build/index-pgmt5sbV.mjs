...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<!--[--><section class="pt-20" id="work" data-v-fadadad3><div class="relative group h-[70vh] min-h-[550px] md:h-[570px] lg:h-[700px] xl:h-[900px] overflow-y-visible overflow-x-clip pb-8" data-v-fadadad3><h2 class="mb-6 lg:mb-18 max-w-full px-8 lg:px-12 lg:max-w-[1024px] xl:max-w-[1440px] mx-auto text-2xl lg:text-5xl placeholder-line" data-splitting="words" data-v-fadadad3> Featured Work</h2><div class="splideSlider relative" data-v-fadadad3>`);
            ...
            ssrRenderList(unref(work), (slide, index) => {
              _push2(ssrRenderComponent(unref(SplideSlide), {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<div class="relative rounded-xl overflow-hidden flex flex-col justify-center items-center" data-v-fadadad3${_scopeId2}>`);
                    if (loaded.value) {
                      _push3(`<div class="flex flex-col md:flex-row justify-center items-start gap-8" data-v-fadadad3${_scopeId2}><img${ssrRenderAttr("src", slide.image.replace("/q_auto,f_auto", "/q_auto,f_auto,w_1260"))} class="w-full object-cover rounded-xl group-[.is-active]:w-[90%] md:group-[.is-active]:w-[var(--width-slide)] transition-all cursor-pointer duriation-900" data-v-fadadad3${_scopeId2}><div class="opacity-0 rounded-xl w-0 group-[.is-active]:opacity-100 group-[.is-active]:w-[20%] transition-all duriation-900 hidden md:block overflow-clip" data-v-fadadad3${_scopeId2}><video class="aspect-mobile"${ssrRenderAttr("data-src", slide.video.replace("q_auto", "q_auto,w_480"))} playsinline muted="" loop${ssrRenderAttr("poster", slide.video.replace(".m3u8", ".webp").replace("q_auto", "q_auto,so_0.2"))} data-v-fadadad3${_scopeId2}></video></div></div>`);
                    } else {
                      _push3(`<!---->`);
                    }
                    _push3(`<div class="h-0 opacity-0 flex flex-col justify-end items-start py-6 md:p-6 group-[.is-active]:opacity-100 group-[.is-active]:h-full transition-all duriation-700 w-[85%] lg:w-[65%] lg:mr-26" data-v-fadadad3${_scopeId2}><h3 class="${ssrRenderClass([slide.textColor, "text-2xl font-bold mb-2 subtle-slide-in"])}" data-v-fadadad3${_scopeId2}>${ssrInterpolate(slide.title)}</h3><div class="flex flex-col gap-6 mb-4" data-v-fadadad3${_scopeId2}><div class="flex flex-col justify-between pr-8 lg:pr-18" data-v-fadadad3${_scopeId2}><p class="${ssrRenderClass([slide.textColor, "text-base subtle-slide-in"])}" style="${ssrRenderStyle({ "--theme-main-animation-delay": "0.2s" })}" data-v-fadadad3${_scopeId2}>${ssrInterpolate(truncateHtmlText(slide.text, 100))}</p></div><div class="flex gap-2 group/ctas flex-wrap max-w-75 flex-col mt-6 md:mt-0" data-v-fadadad3${_scopeId2}>`);
      ...
      _push(`</div><button class="${ssrRenderClass([[isHovered.value ? "md:opacity-80" : ""], "mt-8 block -right-2 md:-right-8 lg:right-65 xl:right-95 mx-auto text-white px-6 py-2 rounded-full transition duriation-900 cursor-pointer w-24 md:w-50 flex flex-col justify-center items-center group/slider h-26 md:h-50 hover:opacity-80 dark:hover:bg-primary/20 inverted:bg-background/0 absolute bottom-90 md:bottom-0 xl:bottom-25"])}" data-v-fadadad3><svg fill="none" stroke-width="1.5" viewBox="0 0 24 24" class="${ssrRenderClass([activeTextColor.value, "w-24 md:w-50"])}" xmlns="http://www.w3.org/2000/svg" data-v-fadadad3><path d="M9 6L15 12L9 18" class="stroke-current" stroke-linecap="round" stroke-linejoin="round" data-v-fadadad3></path></svg><svg class="${ssrRenderClass([activeTextColor.value, "absolute inset-0 rounded-[9rem] w-full h-full pointer-events-none opacity-0 group-hover/slider:opacity-100 animate-spin-slow z-0"])}" viewBox="0 0 100 100" data-v-fadadad3><circle cx="50" cy="50" r="45" fill="none" stroke="currentColor" stroke-width="6"${ssrRenderAttr("stroke-dasharray", strokeLength)}${ssrRenderAttr("stroke-dashoffset", progressOffset.value)} class="transition-all duration-100 ease-linear" data-v-fadadad3></circle></svg></button></div></section><div class="hidden stroke-sunburn-orange stroke-" data-v-fadadad3></div><!--]-->`);
    };
  }
};
...
const FeaturedWork = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-fadadad3"]]);
const _sfc_main = {
  __name: "index",
  __ssrInlineRender: true,
  setup(__props) {
...
//# sourceMappingURL=index-pgmt5sbV.mjs.map
