import { mergeProps, ref, reactive, computed, unref, useSSRContext } from 'file://C:/Users/emmta/Local%20Sites/newportfolio/node_modules/vue/index.mjs';
...
const _sfc_main$4 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</span><span class="sr-only">Dark Mode</span><input type="checkbox" class="sr-only peer"${ssrIncludeBooleanAttr(unref(store).isDark) ? " checked" : ""}${ssrRenderAttr("name", __props.footer ? "mode-footer" : "mode")}${ssrRenderAttr("id", __props.footer ? "mode-footer" : "mode")}>`);
      if (unref(store).useMode) {
...
const Hamburger = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-ad68b8a7"]]);
let Splitting = () => [];
const _sfc_main$2 = {
  __name: "Contact",
  __ssrInlineRender: true,
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-d9fd3423><div class="h-full flex items-center sticky top-45 justify-center mx-auto pb-12 mb-4 lg:mb-8 px-6 flex-col max-w-[778px] relative xl:pb-24 xl:pb-16" data-v-d9fd3423><h3 data-splitting="words" id="formHeader" class="${ssrRenderClass([submitted.value ? "blur-sm" : "", "text-4xl font-black transition-all text-center mb-6 lg:mb-12 form-header uppercase placeholder-line"])}" data-v-d9fd3423>Lets get in touch!</h3>`);
      if (submitted.value) {
        _push(`<div class="text-center pt-16 fade-up absolute z-30" id="thanks" data-v-d9fd3423><h4 class="text-3xl mb-2 font-bold mb-2 text-yellow" data-v-d9fd3423>Success</h4><p class="text-white" data-v-d9fd3423>ss </p></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<form novalidate class="${ssrRenderClass([submitted.value ? "blur-md opacity-25" : "", "transition-all w-full px-2 block flex flex-col gap-6 text-primary dark:text-accent inverted:text-electric-purple"])}" data-v-d9fd3423>`);
      if (error.value) {
        _push(`<div class="text-electric-purple text-sm mb-2" data-v-d9fd3423>${ssrInterpolate(error.value)}</div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<div class="flex flex-wrap w-full" data-v-d9fd3423><div class="relative w-1/2 pr-4" data-v-d9fd3423><label class="sr-only focus:not-sr-only" tabindex="0" for="name" data-v-d9fd3423> Name </label><input type="text" placeholder="Name" id="name" name="name"${ssrRenderAttr("value", formDataValues.name)} class="${ssrRenderClass([{ "border-b border-yellow": nameError.value }, "w-full outline-0 h-12 pb-2 p bg-transparent border-current border rounded-[6rem] pl-6 py-[10px] pr-3 outline-none transition-all active:border-green disabled:cursor-default disabled:bg-gray-2 text-xl focus:border-green bg-transparent text-primary dark:text-accent inverted:text-electric-purple placeholder:text-primary/60 focus:placeholder:text-primary dark:placeholder:text-accent/60 dark:focus:placeholder:text-accent inverted:placeholder:text-electric-purple/60 inverted:focus:placeholder:text-electric-purple"])}" data-v-d9fd3423></div><div class="w-1/2" data-v-d9fd3423><label for="email" class="sr-only focus:not-sr-only" tabindex="0" data-v-d9fd3423> Email </label><input type="email" id="email" placeholder="Email" name="email"${ssrRenderAttr("value", formDataValues.email)} required class="${ssrRenderClass([{ "border-b border-yellow": emailError.value }, "w-full outline-0 h-12 pb-2 p bg-transparent border-current border rounded-[6rem] pl-6 py-[10px] pr-3 outline-none transition-all active:border-green disabled:cursor-default disabled:bg-gray-2 text-xl focus:border-green text-primary dark:text-accent inverted:text-electric-purple placeholder:text-primary/60 focus:placeholder:text-primary dark:placeholder:text-accent/60 dark:focus:placeholder:text-accent inverted:placeholder:text-electric-purple/60 inverted:focus:placeholder:text-electric-purple"])}" data-v-d9fd3423></div></div><label for="message" class="sr-only focus:not-sr-only" tabindex="0" data-v-d9fd3423> Type your message </label><textarea class="${ssrRenderClass([{ "border-b border-yellow": messageError.value }, "placeholder:text-current/60 focus:placeholder:text-current outline-0 h-22 pb-2 p bg-transparent border-current border rounded-[1rem] pl-6 py-6 text-primary dark:text-accent inverted:text-electric-purple"])}" id="message" name="message" placeholder="Your message" required data-v-d9fd3423>${ssrInterpolate(formDataValues.message)}</textarea><div class="hidden" data-v-d9fd3423><input type="text" id="hpField" name="hpField"${ssrRenderAttr("value", formDataValues.hpField)} tabindex="-1" autocomplete="off" data-v-d9fd3423></div><div data-v-d9fd3423><button type="submit" class="relative submit flex items-center transition-all overflow-hidden w-60 ml-auto text-center group/cta" data-v-d9fd3423><span class="inline-block font-semibold px-4 py-2 border-current border-2 rounded-full transition-all-all relative z-10 bg-inherit w-full whitespace-nowrap" data-v-d9fd3423> Submit </span><span class="absolute right-0 top-0 w-0 h-full opacity-0 transition-all-all z-0 origin-left block overflow-clip" data-v-d9fd3423><span class="flex items-center justify-center rounded-r-full bg-current h-full transition-all-all z-0 origin-left block w-10" data-v-d9fd3423><svg class="arrow w-24 h-24 fill-current" viewBox="0 0 24 24" data-v-d9fd3423><path d="M8 5l8 7-8 7z" data-v-d9fd3423></path></svg></span></span></button></div></form></div></section>`);
    };
  }
};
...
const Contact = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-d9fd3423"]]);
const _sfc_main$1 = {
  __name: "SecondaryNav",
  __ssrInlineRender: true,
  props: {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "secondary-nav group/secondaryNav max-w-1440 px-0 md:px-12 flex justify-end items-center relative gap-8 md:gap-6 z-200" }, _attrs))} data-v-e82f1e98>`);
      _push(ssrRenderComponent(_sfc_main$4, { footer: __props.footer }, null, _parent));
...
const SecondaryNav = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-e82f1e98"]]);
const _sfc_main = {
  __name: "Footer",
  __ssrInlineRender: true,
  setup(__props) {
...
export { Contact as C, Hamburger as H, Splitting as S, _sfc_main as _, SecondaryNav as a, _sfc_main$7 as b, _sfc_main$8 as c, _sfc_main$4 as d, _sfc_main$5 as e };
//# sourceMappingURL=Footer-CAUF-K31.mjs.map
