import { mergeProps, ref, useSSRContext } from 'file://C:/Users/emmta/Local%20Sites/newportfolio/node_modules/vue/index.mjs';
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<a${ssrRenderAttrs(mergeProps({
        ...
        ref_key: "linkEl",
        ref: linkEl
      }, _attrs))} data-v-a0a116ee><span class="nav-item" data-v-a0a116ee>${(_a = __props.text) != null ? _a : ""}</span></a>`);
    };
  }
};
...
const Links = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-a0a116ee"]]);
const _sfc_main = {
  __name: "Wordpress",
  __ssrInlineRender: true,
  setup(__props) {
...
//# sourceMappingURL=Wordpress-jmS9r4B2.mjs.map
