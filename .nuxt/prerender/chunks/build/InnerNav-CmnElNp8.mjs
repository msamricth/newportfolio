...
import { mergeProps, withCtx, createBlock, openBlock, createVNode, ref, watch, nextTick, createTextVNode, toDisplayString, computed, useSSRContext } from 'file://C:/Users/emmta/Local%20Sites/newportfolio/node_modules/vue/index.mjs';
...
import { c as _sfc_main$4, d as _sfc_main$5, H as Hamburger, S as Splitting } from './Footer-D1OIHc6g.mjs';
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "secondary-nav group/secondaryNav max-w-1440 px-0 md:px-12 flex justify-end items-center relative gap-8 md:gap-6 dark:text-background inverted:text-background text-primary" }, _attrs))} data-v-16b87aab>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<svg class="absolute inset-0 stroke-current" viewBox="0 0 512 512" fill="none" xmlns="http://www.w3.org/2000/svg" data-v-16b87aab${_scopeId}><polyline points="112 352 48 288 112 224" stroke-linecap="round" stroke-linejoin="round" stroke-width="32" data-v-16b87aab${_scopeId}></polyline><path d="M64,288H358c58.76,0,106-49.33,106-108V160" stroke-linecap="round" stroke-linejoin="round" stroke-width="32" data-v-16b87aab${_scopeId}></path></svg><svg class="absolute inset-0 stroke-current text-accent transition-all duration-700 ease-in-out stroke-animate" viewBox="0 0 512 512" fill="none" xmlns="http://www.w3.org/2000/svg" data-v-16b87aab${_scopeId}><polyline points="112 352 48 288 112 224" stroke-linecap="round" stroke-linejoin="round" stroke-width="32" data-v-16b87aab${_scopeId}></polyline><path d="M64,288H358c58.76,0,106-49.33,106-108V160" stroke-linecap="round" stroke-linejoin="round" stroke-width="32" data-v-16b87aab${_scopeId}></path></svg>`);
          } else {
            return [
...
const InnerSecondaryNav = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-16b87aab"]]);
const _sfc_main = {
  __name: "InnerNav",
  __ssrInlineRender: true,
  props: {
...
//# sourceMappingURL=InnerNav-CmnElNp8.mjs.map
