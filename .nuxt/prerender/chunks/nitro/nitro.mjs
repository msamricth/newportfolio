import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { defineEventHandler, handleCacheHeaders, splitCookiesString, isEvent, createEvent, fetchWithEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, getRequestURL, getResponseHeader, appendResponseHeader, removeResponseHeader, createError, getRequestHost, getRequestProtocol, setHeader, getHeader, getResponseStatus, getQuery as getQuery$1, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler } from 'file:///Users/emmatalarico/www/newportfolio/node_modules/h3/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, hasProtocol, withHttps, decodePath, withLeadingSlash, withoutTrailingSlash, withoutProtocol, withTrailingSlash, withBase, parsePath, parseQuery, stringifyQuery, encodePath, stringifyParsedURL, joinRelativeURL } from 'file:///Users/emmatalarico/www/newportfolio/node_modules/ufo/dist/index.mjs';
import destr from 'file:///Users/emmatalarico/www/newportfolio/node_modules/destr/dist/index.mjs';
import { createHooks } from 'file:///Users/emmatalarico/www/newportfolio/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file:///Users/emmatalarico/www/newportfolio/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file:///Users/emmatalarico/www/newportfolio/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, defineDriver, prefixStorage } from 'file:///Users/emmatalarico/www/newportfolio/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/emmatalarico/www/newportfolio/node_modules/unstorage/drivers/fs.mjs';
import fsDriver from 'file:///Users/emmatalarico/www/newportfolio/node_modules/unstorage/drivers/fs-lite.mjs';
import lruCache from 'file:///Users/emmatalarico/www/newportfolio/node_modules/unstorage/drivers/lru-cache.mjs';
import { digest } from 'file:///Users/emmatalarico/www/newportfolio/node_modules/ohash/dist/index.mjs';
import { klona } from 'file:///Users/emmatalarico/www/newportfolio/node_modules/klona/dist/index.mjs';
import defu, { defuFn, defu as defu$1, createDefu } from 'file:///Users/emmatalarico/www/newportfolio/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file:///Users/emmatalarico/www/newportfolio/node_modules/scule/dist/index.mjs';
import { getContext } from 'file:///Users/emmatalarico/www/newportfolio/node_modules/unctx/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/emmatalarico/www/newportfolio/node_modules/radix3/dist/index.mjs';
import { toValue } from 'file:///Users/emmatalarico/www/newportfolio/node_modules/vue/index.mjs';
import { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { dirname, resolve as resolve$1 } from 'file:///Users/emmatalarico/www/newportfolio/node_modules/pathe/dist/index.mjs';
import { createConsola } from 'file:///Users/emmatalarico/www/newportfolio/node_modules/consola/dist/index.mjs';

const serverAssets = [{"baseName":"server","dir":"/Users/emmatalarico/www/newportfolio/src/server/assets"}];
 ...
 */
const _47Users_47emmatalarico_47www_47newportfolio_47node_modules_47nuxt_47dist_47core_47runtime_47nitro_47utils_47cache_45driver_46js = defineDriver((opts) => {
...
storage.mount('internal:nuxt:prerender', _47Users_47emmatalarico_47www_47newportfolio_47node_modules_47nuxt_47dist_47core_47runtime_47nitro_47utils_47cache_45driver_46js({"driver":"/Users/emmatalarico/www/newportfolio/node_modules/nuxt/dist/core/runtime/nitro/utils/cache-driver.js","base":"/Users/emmatalarico/www/newportfolio/.nuxt/cache/nitro/prerender"}));
storage.mount('data', fsDriver({"driver":"fsLite","base":"./.data/kv"}));
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/emmatalarico/www/newportfolio","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/emmatalarico/www/newportfolio/src/server","watchOptions":{"ignored":[null]}}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/emmatalarico/www/newportfolio/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/emmatalarico/www/newportfolio/.nuxt/cache"}));
...
const assets = {
  ...
  "/services/_payload.json": {
    ...
    "mtime": "2025-09-02T02:34:34.572Z",
    "size": 69,
    "path": "../../.output/public/services/_payload.json"
  },
  "/services/index.html": {
    "type": "text/html; charset=utf-8",
    ...
    "size": 135186,
    "path": "../../.output/public/services/index.html"
  },
  "/work/_payload.json": {
    "type": "application/json",
    "etag": "\"45-/pkWYGYXAZlGSUfPPJkxgY+sEI4\"",
...
const _lazy_c2bE1x = () => import('../_/renderer.mjs').then(function (n) { return n.r; });
