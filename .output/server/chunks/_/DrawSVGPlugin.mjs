  ...
  render: function render(ratio, data) {
    if (data.tween._time || !_reverting()) {
      ...
      if (pt) {
        ...
        offset = data._offset;
        dash && offset && dash + Math.abs(offset % data._length) > data._length - 0.05 && (offset += offset < 0 ? 0.005 : -5e-3) && (length += 0.005);
...
export { DrawSVGPlugin as D };
//# sourceMappingURL=DrawSVGPlugin.mjs.map
