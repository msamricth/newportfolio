...
import { C as Contact, _ as _sfc_main$f, a as SecondaryNav, S as Splitting } from './Footer-CwtjJahA.mjs';
...
const SplideSlide = /* @__PURE__ */ _export_sfc(_sfc_main$e, [["render", _sfc_render]]);
...
const Nav = /* @__PURE__ */ _export_sfc$1(_sfc_main$d, [["__scopeId", "data-v-4af30548"]]);
const _sfc_main$c = {};
...
const Mixer = /* @__PURE__ */ _export_sfc$1(_sfc_main$c, [["ssrRender", _sfc_ssrRender$6]]);
const _sfc_main$b = {};
...
const _sfc_main$5 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div><div class="${ssrRenderClass([{ "loaded": unref(store).loaded }, "headline-wrapper decor-grid group"])}"><h1 class="headline font-heading font-black text-6xl leading-none xl:pt-8 **:align-sub mt-6 uppercase placeholder-line opacity-0 max-md:min-h-110" data-splitting="words"> Building digital bridges between ideas &amp; impact </h1><div class="${ssrRenderClass([{ "-translate-x-[calc((50vw+30px)-22vw)] translate-y-[5vh] md:translate-x-0 md:-translate-y-[calc(560px-50vh)]  lg:translate-x-5": !loading.value }, "decor-wrap preloading transition-all duration-1000 justify-center items-center flex md:order-4 lg:order-3 group-[.loaded]:transition-[filter]"])}">`);
      _push(ssrRenderComponent(Mixer, {
        class: ["decor h-auto transition-all", loading.value ? "jello-horizontal" : "animate subtle-slide-in-attention scale-200"],
        width: "180",
        height: "180",
        style: !loading.value ? "--theme-main-animation-delay: 100ms" : animDelay.value
      }, null, _parent));
      ...
      _push(`</div><div class="${ssrRenderClass([{ "-translate-x-[calc((50vw+30px)-22vw)] translate-y-[8vh] md:translate-x-[19vw] lg:translate-x-[5vw] md:-translate-y-[calc(555px-50vh)]": !loading.value }, "decor-wrap preloading transition-all duration-1000 md:order-5 group-[.loaded]:transition-[filter]"])}">`);
      _push(ssrRenderComponent(Flower2, {
        width: "180",
        height: "180",
        class: ["decor h-auto transition-all", loading.value ? "rotate-ccw90-forever" : "animate subtle-slide-in-attention scale-200"],
        style: !loading.value ? "--theme-main-animation-delay: 200ms" : animDelay.value
      }, null, _parent));
      ...
      _push(`</div><div class="${ssrRenderClass([{ "-translate-x-[calc((50vw+20px)-22vw)] translate-y-[10vh] md:-translate-y-[calc(570px-50vh)] md:-translate-x-[0vw]  lg:-translate-x-[2vw]": !loading.value }, "decor-wrap preloading transition-all duration-1000 md:order-8 group-[.loaded]:transition-[filter]"])}">`);
      _push(ssrRenderComponent(Code, {
        class: ["decor h-auto transition-all", loading.value ? "vibrate" : "animate subtle-slide-in-attention scale-250"],
        width: "180",
        height: "180",
        style: !loading.value ? "--theme-main-animation-delay: 300ms" : animDelay.value
      }, null, _parent));
...
//# sourceMappingURL=index-Dr8Ag4-A.mjs.map
