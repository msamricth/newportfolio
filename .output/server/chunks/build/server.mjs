...
const _routes = [
  ...
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-BD3ttP-Z.mjs')
  },
  {
    name: "work-glt",
    path: "/work/glt",
...
const _sfc_main$2 = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "bg-electric-purple inverted:bg-primary min-h-60 relative py-6 md:py-12 group/footer" }, _attrs))}><div class="utilties max-w-full px-8 md:px-0 lg:max-w-[1024px] xl:max-w-[1440px] mx-auto">`);
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const props = __props;
    useHead({
      titleTemplate: "Code Artisan | " + ((_a = props.error) == null ? void 0 : _a.statusCode),
