  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(store).ready) {
        _push(`<h3 class="order-1 pb-20 text-3xl lg:text-4xl 2xl:text-6xl font-black lg:pb-46 font-heading md:order-2 px-8 lg:px-12 lg:max-w-[1024px] xl:max-w-[1440px] mx-auto animate subtle-slide-in"> Sorry, nothing here!</h3>`);
      } else {
        _push(`<!---->`);
      }
