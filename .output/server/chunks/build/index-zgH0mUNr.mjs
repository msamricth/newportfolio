...
import { ssrRenderComponent, ssrRenderStyle, ssrRenderList, ssrRenderClass, ssrRenderAttr, ssrInterpolate, ssrRenderAttrs } from 'vue/server-renderer';
import { I as InnerSecondaryNav, a as InnerNav } from './InnerNav-Ez5yWfyP.mjs';
import { C as Contact, _ as _sfc_main$3 } from './Footer-DWew6Ibk.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="work-grid flex flex-wrap gap-6 w-full lg:w-3/4" style="${ssrRenderStyle(unref(mainStore).loaded ? null : { display: "none" })}">`);
...
//# sourceMappingURL=index-zgH0mUNr.mjs.map
