...
import { I as InnerNav, C as Contact, _ as _sfc_main$2 } from './Footer-BchO7Jlg.mjs';
...
const work = [
  {
    ...
    specialties: [
      ...
      "Components built using ACF fields",
      "GSAP Animations"
    ],
    tech: [
      "Bootstrap",
  ...
  },
  {
    ...
    specialties: [
      ...
      "Plugin and Theme Development",
      "Components built using ACF fields",
      "Elementor Components + Extensions"
    ],
    tech: [
      "Bootstrap",
      "ACF",
  ...
  },
  {
    ...
    specialties: [
      "Delivering exceptional digital products with tight constraints",
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      var _a;
      _push(`<!--[--><div class="font-main bg-background text-primary dark:text-background dark:bg-deep-purple inverted:text-background inverted:bg-deep-purple inverted:dark:bg-background inverted:dark:text-primary transition duration-700 relative overflow-clip">`);
...
//# sourceMappingURL=index-DkDsngKg.mjs.map
