...
import { mergeProps, ref, watch, withCtx, createTextVNode, toDisplayString, createVNode, reactive, computed, createBlock, openBlock, unref, useSSRContext } from 'vue';
...
const useMainStore = defineStore("main", {
  ...
  actions: {
    ...
    setupDarkMode() {
      ...
      (void 0).body.classList.toggle("inverted", this.darkMode === "dark");
    },
    toggleTheme(value) {
      this.darkMode = value ? "dark" : "light";
      localStorage.setItem("theme", this.darkMode);
      (void 0).body.classList.toggle("inverted", value);
    }
  }
});
const _sfc_main$6 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      if (!__props.footer) {
        ...
        }, _attrs))} data-v-25e189de><div class="hamburger-box text-current transition-all duration-700 **:transition-all **:duration-700" data-v-25e189de><div class="hamburger-inner text-current **:transition-all **:duration-700" data-v-25e189de></div></div></button>`);
      } else {
        _push(`<!---->`);
      }
    };
...
const Hamburger = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-25e189de"]]);
const _sfc_main$4 = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "secondary-nav group/secondaryNav max-w-1440 px-0 md:px-12 flex justify-end items-center relative gap-8 md:gap-6 dark:text-background inverted:text-background text-primary" }, _attrs))} data-v-4a59dd48>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<svg class="absolute inset-0 stroke-current" viewBox="0 0 512 512" fill="none" xmlns="http://www.w3.org/2000/svg" data-v-4a59dd48${_scopeId}><polyline points="112 352 48 288 112 224" stroke-linecap="round" stroke-linejoin="round" stroke-width="32" data-v-4a59dd48${_scopeId}></polyline><path d="M64,288H358c58.76,0,106-49.33,106-108V160" stroke-linecap="round" stroke-linejoin="round" stroke-width="32" data-v-4a59dd48${_scopeId}></path></svg><svg class="absolute inset-0 stroke-current text-accent transition-all duration-700 ease-in-out stroke-animate" viewBox="0 0 512 512" fill="none" xmlns="http://www.w3.org/2000/svg" data-v-4a59dd48${_scopeId}><polyline points="112 352 48 288 112 224" stroke-linecap="round" stroke-linejoin="round" stroke-width="32" data-v-4a59dd48${_scopeId}></polyline><path d="M64,288H358c58.76,0,106-49.33,106-108V160" stroke-linecap="round" stroke-linejoin="round" stroke-width="32" data-v-4a59dd48${_scopeId}></path></svg>`);
          } else {
            return [
              (openBlock(), createBlock("svg", {
                class: "absolute inset-0 stroke-current",
                viewBox: "0 0 512 512",
                fill: "none",
              ...
              (openBlock(), createBlock("svg", {
                class: "absolute inset-0 stroke-current text-accent transition-all duration-700 ease-in-out stroke-animate",
                viewBox: "0 0 512 512",
                fill: "none",
                xmlns: "http://www.w3.org/2000/svg"
              }, [
...
const InnerSecondaryNav = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-4a59dd48"]]);
const _sfc_main$3 = {
  __name: "InnerNav",
  __ssrInlineRender: true,
  props: {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_NuxtLink = __nuxt_component_0;
      _push(`<!--[--><div class="utilities max-w-full px-8 lg:px-12 lg:max-w-[1024px] xl:max-w-[1440px] mx-auto pt-9 lg:pt-24 pb-18 lg:pb-20" data-v-a26fb90d>`);
      _push(ssrRenderComponent(InnerSecondaryNav, null, null, _parent));
      _push(`</div><header class="${ssrRenderClass([isSticky.value ? "fixed left-0 w-full bg-background/70 dark:bg-primary/70 inverted:bg-primary/70 inverted:dark:bg-background/70 backdrop-blur transition duration-700" : " absolute ", "py-4 mx-auto z-20 w-full will-change-transform transform-gpu"])}" data-v-a26fb90d><div class="nav-wrapper max-w-full px-8 lg:px-12 lg:max-w-[1024px] xl:max-w-[1440px] mx-auto flex items-center relative" data-v-a26fb90d><div class="${ssrRenderClass([isSticky.value ? "opacity-75 duration-700 hover:opacity-100" : "opacity-0 duration-0", "text-primary dark:text-background inverted:text-background inverted:dark:text-primary nav-brand transition-all relative max-sm:z-10"])}" data-v-a26fb90d>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        "aria-label": "Return Home",
        to: __props.brandURL,
      ...
      _push(`</div><h1 class="placeholder-line absolute left-8 lg:left-12 transition-all headingClass top-0 text-3xl md:text-5xl text-nowrap" data-splitting="words" data-v-a26fb90d><span class="transition-all duration-700 placeholder-line text-primary dark:text-background inverted:text-background" data-splitting="words" data-v-a26fb90d>${ssrInterpolate(__props.title)}</span></h1><nav class="${ssrRenderClass([isSticky.value ? [""] : ["opacity-0"], "flex space-x-8 text-sm font-heading font-semibold group/nav ml-auto text-primary dark:text-background inverted:text-background inverted:dark:text-primary"])}" data-v-a26fb90d>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span class="nav-item" data-v-a26fb90d${_scopeId}>about</span>`);
          } else {
            return [
              createVNode("span", {
                class: "nav-item",
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span class="nav-item" data-v-a26fb90d${_scopeId}>work</span>`);
          } else {
            return [
              createVNode("span", {
                class: "nav-item",
      ...
      _push(`<a href="#sayHello" class="group-hover/nav:opacity-70 group-hover/nav:hover:opacity-100 transition relative overflow-clip duration-700" data-v-a26fb90d><span class="nav-item" data-v-a26fb90d>say hello</span></a></nav></div></header><!--]-->`);
    };
  }
};
...
const InnerNav = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-a26fb90d"]]);
const _sfc_main$2 = {
  __name: "Contact",
  __ssrInlineRender: true,
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-449c0f38><div class="h-full flex items-center sticky top-45 justify-center mx-auto pb-12 mb-4 lg:mb-8 px-6 flex-col max-w-[778px] relative xl:pb-24 xl:pb-16" data-v-449c0f38><h3 data-splitting="words" id="formHeader" class="${ssrRenderClass([submitted.value ? "blur-sm" : "", "text-4xl font-black transition-all text-center mb-6 lg:mb-12 form-header uppercase placeholder-line"])}" data-v-449c0f38>Lets get in touch!</h3>`);
      if (submitted.value) {
        _push(`<div class="text-center pt-16 fade-up absolute z-30" id="thanks" data-v-449c0f38><h4 class="text-3xl mb-2 font-bold mb-2 text-yellow" data-v-449c0f38>Success</h4><p class="text-white" data-v-449c0f38>ss </p></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<form novalidate class="${ssrRenderClass([submitted.value ? "blur-md opacity-25" : "", "transition-all w-full px-2 block flex flex-col gap-6 text-primary dark:text-accent inverted:text-electric-purple"])}" data-v-449c0f38>`);
      if (error.value) {
        _push(`<div class="text-electric-purple text-sm mb-2" data-v-449c0f38>${ssrInterpolate(error.value)}</div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<div class="flex flex-wrap w-full" data-v-449c0f38><div class="relative w-1/2 pr-4" data-v-449c0f38><label class="sr-only focus:not-sr-only" tabindex="0" for="name" data-v-449c0f38> Name </label><input type="text" placeholder="Name" id="name" name="name"${ssrRenderAttr("value", formDataValues.name)} class="${ssrRenderClass([{ "border-b border-yellow": nameError.value }, "w-full outline-0 h-12 pb-2 p bg-transparent border-current border rounded-[6rem] pl-6 py-[10px] pr-3 outline-none transition-all active:border-green disabled:cursor-default disabled:bg-gray-2 text-xl focus:border-green bg-transparent text-primary dark:text-accent inverted:text-electric-purple placeholder:text-primary/60 focus:placeholder:text-primary dark:placeholder:text-accent/60 dark:focus:placeholder:text-accent inverted:placeholder:text-electric-purple/60 inverted:focus:placeholder:text-electric-purple"])}" data-v-449c0f38></div><div class="w-1/2" data-v-449c0f38><label for="email" class="sr-only focus:not-sr-only" tabindex="0" data-v-449c0f38> Email </label><input type="email" id="email" placeholder="Email" name="email"${ssrRenderAttr("value", formDataValues.email)} required class="${ssrRenderClass([{ "border-b border-yellow": emailError.value }, "w-full outline-0 h-12 pb-2 p bg-transparent border-current border rounded-[6rem] pl-6 py-[10px] pr-3 outline-none transition-all active:border-green disabled:cursor-default disabled:bg-gray-2 text-xl focus:border-green text-primary dark:text-accent inverted:text-electric-purple placeholder:text-primary/60 focus:placeholder:text-primary dark:placeholder:text-accent/60 dark:focus:placeholder:text-accent inverted:placeholder:text-electric-purple/60 inverted:focus:placeholder:text-electric-purple"])}" data-v-449c0f38></div></div><textarea class="${ssrRenderClass([{ "border-b border-yellow": messageError.value }, "placeholder:text-current/60 focus:placeholder:text-current outline-0 h-22 pb-2 p bg-transparent border-current border rounded-[1rem] pl-6 py-6 text-primary dark:text-accent inverted:text-electric-purple"])}" id="message" name="message" placeholder="Your message" required data-v-449c0f38>${ssrInterpolate(formDataValues.message)}</textarea><div class="hidden" data-v-449c0f38><input type="text" id="hpField" name="hpField"${ssrRenderAttr("value", formDataValues.hpField)} tabindex="-1" autocomplete="off" data-v-449c0f38></div><div data-v-449c0f38><button type="submit" class="relative submit flex items-center transition-all overflow-hidden w-60 ml-auto text-center group/cta" data-v-449c0f38><span class="inline-block font-semibold px-4 py-2 border-current border-2 rounded-full transition-all-all relative z-10 bg-inherit w-full whitespace-nowrap" data-v-449c0f38> Submit </span><span class="absolute right-0 top-0 w-0 h-full opacity-0 transition-all-all z-0 origin-left block overflow-clip" data-v-449c0f38><span class="flex items-center justify-center rounded-r-full bg-current h-full transition-all-all z-0 origin-left block w-10" data-v-449c0f38><svg class="arrow w-24 h-24 fill-current" viewBox="0 0 24 24" data-v-449c0f38><path d="M8 5l8 7-8 7z" data-v-449c0f38></path></svg></span></span></button></div></form></div></section>`);
    };
  }
};
...
const Contact = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-449c0f38"]]);
const _sfc_main$1 = {
  __name: "SecondaryNav",
  __ssrInlineRender: true,
  props: {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "secondary-nav group/secondaryNav max-w-1440 px-0 md:px-12 flex justify-end items-center relative gap-8 md:gap-6 group-hover/footer:text-primary" }, _attrs))} data-v-82b99aa5>`);
      _push(ssrRenderComponent(_sfc_main$6, null, null, _parent));
      _push(ssrRenderComponent(_sfc_main$7, null, null, _parent));
...
const SecondaryNav = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-82b99aa5"]]);
const _sfc_main = {
  __name: "Footer",
  __ssrInlineRender: true,
  setup(__props) {
...
export { Contact as C, InnerNav as I, _sfc_main as _, _sfc_main$9 as a, useMainStore as u };
//# sourceMappingURL=Footer-BchO7Jlg.mjs.map
