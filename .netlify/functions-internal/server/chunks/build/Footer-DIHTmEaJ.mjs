...
import gsap$3, { gsap as gsap$2 } from 'gsap';
...
const Hamburger = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-25e189de"]]);
gsap$3.registerPlugin(ScrollTrigger);
const _sfc_main$2 = {
  __name: "Contact",
  __ssrInlineRender: true,
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-590f12c0><div class="h-full flex items-center sticky top-45 justify-center mx-auto pb-12 mb-4 lg:mb-8 px-6 flex-col max-w-[778px] relative xl:pb-24 xl:pb-16" data-v-590f12c0><h3 data-splitting="words" id="formHeader" class="${ssrRenderClass([submitted.value ? "blur-sm" : "", "text-4xl font-black transition-all text-center mb-6 lg:mb-12 form-header uppercase placeholder-line"])}" data-v-590f12c0>Lets get in touch!</h3>`);
      if (submitted.value) {
        _push(`<div class="text-center pt-16 fade-up absolute z-30" id="thanks" data-v-590f12c0><h4 class="text-3xl mb-2 font-bold mb-2 text-yellow" data-v-590f12c0>Success</h4><p class="text-white" data-v-590f12c0>ss </p></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<form novalidate class="${ssrRenderClass([submitted.value ? "blur-md opacity-25" : "", "transition-all w-full px-2 block flex flex-col gap-6 text-primary dark:text-accent inverted:text-electric-purple"])}" data-v-590f12c0>`);
      if (error.value) {
        _push(`<div class="text-electric-purple text-sm mb-2" data-v-590f12c0>${ssrInterpolate(error.value)}</div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<div class="flex flex-wrap w-full" data-v-590f12c0><div class="relative w-1/2 pr-4" data-v-590f12c0><label class="sr-only focus:not-sr-only" tabindex="0" for="name" data-v-590f12c0> Name </label><input type="text" placeholder="Name" id="name" name="name"${ssrRenderAttr("value", formDataValues.name)} class="${ssrRenderClass([{ "border-b border-yellow": nameError.value }, "w-full outline-0 h-12 pb-2 p bg-transparent border-current border rounded-[6rem] pl-6 py-[10px] pr-3 outline-none transition-all active:border-green disabled:cursor-default disabled:bg-gray-2 text-xl focus:border-green bg-transparent text-primary dark:text-accent inverted:text-electric-purple placeholder:text-primary/60 focus:placeholder:text-primary dark:placeholder:text-accent/60 dark:focus:placeholder:text-accent inverted:placeholder:text-electric-purple/60 inverted:focus:placeholder:text-electric-purple"])}" data-v-590f12c0></div><div class="w-1/2" data-v-590f12c0><label for="email" class="sr-only focus:not-sr-only" tabindex="0" data-v-590f12c0> Email </label><input type="email" id="email" placeholder="Email" name="email"${ssrRenderAttr("value", formDataValues.email)} required class="${ssrRenderClass([{ "border-b border-yellow": emailError.value }, "w-full outline-0 h-12 pb-2 p bg-transparent border-current border rounded-[6rem] pl-6 py-[10px] pr-3 outline-none transition-all active:border-green disabled:cursor-default disabled:bg-gray-2 text-xl focus:border-green text-primary dark:text-accent inverted:text-electric-purple placeholder:text-primary/60 focus:placeholder:text-primary dark:placeholder:text-accent/60 dark:focus:placeholder:text-accent inverted:placeholder:text-electric-purple/60 inverted:focus:placeholder:text-electric-purple"])}" data-v-590f12c0></div></div><textarea class="${ssrRenderClass([{ "border-b border-yellow": messageError.value }, "placeholder:text-current/60 focus:placeholder:text-current outline-0 h-22 pb-2 p bg-transparent border-current border rounded-[1rem] pl-6 py-6 text-primary dark:text-accent inverted:text-electric-purple"])}" id="message" name="message" placeholder="Your message" required data-v-590f12c0>${ssrInterpolate(formDataValues.message)}</textarea><div class="hidden" data-v-590f12c0><input type="text" id="hpField" name="hpField"${ssrRenderAttr("value", formDataValues.hpField)} tabindex="-1" autocomplete="off" data-v-590f12c0></div><div data-v-590f12c0><button type="submit" class="relative submit flex items-center transition-all overflow-hidden w-60 ml-auto text-center group/cta" data-v-590f12c0><span class="inline-block font-semibold px-4 py-2 border-current border-2 rounded-full transition-all-all relative z-10 bg-inherit w-full whitespace-nowrap" data-v-590f12c0> Submit </span><span class="absolute right-0 top-0 w-0 h-full opacity-0 transition-all-all z-0 origin-left block overflow-clip" data-v-590f12c0><span class="flex items-center justify-center rounded-r-full bg-current h-full transition-all-all z-0 origin-left block w-10" data-v-590f12c0><svg class="arrow w-24 h-24 fill-current" viewBox="0 0 24 24" data-v-590f12c0><path d="M8 5l8 7-8 7z" data-v-590f12c0></path></svg></span></span></button></div></form></div></section>`);
    };
  }
};
...
const Contact = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-590f12c0"]]);
const _sfc_main$1 = {
  __name: "SecondaryNav",
  __ssrInlineRender: true,
  props: {
...
export { Contact as C, Hamburger as H, ScrollTrigger as S, _sfc_main as _, SecondaryNav as a, _sfc_main$7 as b, _sfc_main$4 as c, _sfc_main$5 as d, useMainStore as u };
//# sourceMappingURL=Footer-DIHTmEaJ.mjs.map
