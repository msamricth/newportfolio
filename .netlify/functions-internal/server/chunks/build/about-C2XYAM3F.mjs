...
import { I as InnerNav } from './InnerNav-BDf9tNaI.mjs';
import { C as Contact, _ as _sfc_main$9, u as useMainStore, S as ScrollTrigger } from './Footer-DIHTmEaJ.mjs';
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-24d0bda3><div class="max-w-[1440px] mx-auto px-8 lg:px-12" data-v-24d0bda3><h2 class="text-3xl md:text-4xl font-heading font-bold mb-12 placeholder-line text-center md:text-left" data-splitting="words" data-v-24d0bda3>I want to help</h2><div class="flex gap-10 flex-col" data-v-24d0bda3><!--[-->`);
      ssrRenderList(unref(offerings), (item, index) => {
        _push(`<div class="offering-card" data-v-24d0bda3><div class="gap-6 lg:gap-12 flex-col md:flex-row flex items-center transition-all duration-700 pb-4" data-v-24d0bda3>`);
        if (item.icon) {
          _push(`<div class="icon-btn relative w-24 h-24 group min-w-[120px]" data-v-24d0bda3>`);
        ...
        _push(`<div class="list-content text-center md:text-left" data-v-24d0bda3><h3 class="text-1xl md:text-2xl font-semibold md:mb-2 transition-all duration-700" data-v-24d0bda3>${ssrInterpolate(item.title)}</h3><p class="text-md md:text-base opacity-80 leading-relaxedtransition-all duration-700" data-v-24d0bda3>${ssrInterpolate(item.description)}</p><ul class="mt-4 list-disc list-inside text-sm opacity-70 transition-all duration-700 justify-center flex flex-wrap md:flex-col" data-v-24d0bda3><!--[-->`);
        ssrRenderList(item.points, (point, i) => {
          _push(`<li class="mr-2" data-v-24d0bda3><span class="-ml-2" data-v-24d0bda3>${ssrInterpolate(point)}</span></li>`);
        });
        _push(`<!--]--></ul></div></div><div class="${ssrRenderClass([{ "hidden": index === unref(offerings).length - 1 }, "card-border swing-in-left-fwd-slow h-[2px] bg-current/20 transition duriation-900 mt-4 opacity-0"])}" data-v-24d0bda3></div></div>`);
      });
...
const Offerings = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-24d0bda3"]]);
...
const about = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-38bcfdc6"]]);

export { about as default };
//# sourceMappingURL=about-C2XYAM3F.mjs.map
