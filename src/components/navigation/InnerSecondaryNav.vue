<template>
    <div
        ...
        <NuxtLink aria-label="Return Home" to="/"
            ...
            <svg class="absolute inset-0 stroke-current text-accent transition-all duration-700 ease-in-out stroke-animate group-hover:scale-[1.28] group-hover:stroke-accent"
