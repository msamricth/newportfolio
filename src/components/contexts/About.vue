            ...
            <div class="min-h-screen">
                <div class="introduction-wrapper sticky md:max-w-2/3 mt-4 md:mt-6 top-[15%] md:top-[10%]">
                    ...
                    <div class="placeholder-line" data-splitting="words">
                        <p class="placeholder-line text-secondary text-base leading-[1.8] mb-6 introduction"
                        ...
                        <blockquote class="transition duriation-900 border-l-4 pl-4 mt-4 mb-8 py-2" data-splitting="words"
                        ...
                        <p class="text-secondary text-base leading-[1.8] final-p placeholder-line" data-splitting="words">
