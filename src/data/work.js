export const work = [
    {
        ...
        tech: [
            'Bootstrap',
            'ACF', 'Webpack', 'GSAP', 'WordPress', 'Vimeo', 'React'
    ...
    },
    {
        ...
        tech: [
            'pugJS',
            'Hybris', 'Babel', 'Gulp', 'SCSS', 'MapBox', 'Airtable', 'EventBrite', 'Vimeo', 'Vue'
    ...
    },
    {
        ...
        tech: [
            'WordPress',
            'Sage', 'Bedrock', 'Budd.js', 'Larvel', 'Composer', 'ACF', 'Trellis', 'Tailwind', 'GSAP', 'Cloudinary'
    ...
    },
    {
        ...
        tech: [
            'Vite', 'Vue', 'Pinia', 'GSAP', 'Netlify', 'Tailwind', 'Cloudinary'
