...
const BasicImage = defineAsyncComponent(() => import('@/components/case-studies/sections/BasicImage.vue'))
const Image = defineAsyncComponent(() => import('@/components/case-studies/sections/Image.vue'))
const ImageGist = defineAsyncComponent(() => import('@/components/case-studies/sections/ImageGist.vue'))
const Basic = defineAsyncComponent(() => import('@/components/case-studies/sections/Basic.vue'))
const IconGist = defineAsyncComponent(() => import('@/components/case-studies/sections/IconGist.vue'))
const SlideShow = defineAsyncComponent(() => import('@/components/case-studies/sections/SlideShow.vue'))
    ...
    <div
        ...
        <div ref="container" class="overflow-clip">
            <Basic :heading="sections[0].heading" :paragraph="sections[0].paragraph" :items="sections[0].items"
                :tagIntro="sections[0].tagIntro" :tags="sections[0].tags" v-if="csStore.sectionReady > 0" />
            <Image
                image="https://res.cloudinary.com/dp1qyhhlo/image/upload/v1747698374/1_Pager_11_x_11_in_zcsbil.webp" v-if="csStore.sectionReady > 1" />
            <BasicImage :heading="sections[1].heading" :paragraph="sections[1].paragraph" :items="sections[1].items"
                ...
                image="https://res.cloudinary.com/dp1qyhhlo/image/upload/w_900,f_auto/v1746818135/2_ev2u7a.jpg" v-if="csStore.sectionReady > 2"/>
            <ImageGist :heading="sections[2].heading" :paragraph="sections[2].paragraph" :items="sections[2].items"
                ...
                FileName="sidebarBlockSettings.js" Caption="Block settings for GLT's custom WordPress Theme" v-if="csStore.sectionReady > 3" />
            <IconGist :heading="sections[3].heading" :paragraph="sections[3].paragraph" :items="sections[3].items"
                ...
                Caption="WordPress form builder plugin that connects and syncs with Airtable" :icons="icons" v-if="csStore.sectionReady > 4" />
            <SlideShow :heading="results.heading" :items="results.items" :Images="results.Images"
                :buttonLabel="results.button.label" :buttonHref="results.button.href" v-if="csStore.sectionReady > 5"/>
